...
def _get_external_order(request, order_number):
    ...
    Get information about a paid order. This function makes a request to the E-Commerce Service to see if there is
    ...
    try:
        api = EcommerceAPI()
        order_number, __, order_data = api.get_order(request.user, order_number)
        ...
        order_info = {
            ...
            'purchase_datetime': payment_date,
